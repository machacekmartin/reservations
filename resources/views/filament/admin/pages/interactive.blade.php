<x-filament-panels::page>
    <div x-data="{
        ...
        <div
            class="relative w-full border border-gray-200 shadow rounded-2xl bg-slate-800 cursor-grab active:cursor-grabbing overflow-hidden h-[800px]"
            x-ref="scrollable"
